...
transformSelectedObjects(AffineTransforms.fromRows(matrix[0], matrix[2], matrix[4], matrix[1], matrix[3], matrix[5]))
def transformedAnnotations = getAnnotationObjects()
